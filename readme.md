# 陕西干部网络学院自动刷课工具
## 本库已停止维护，改用playwright实现，项目名SXLearn-playwright。
## 本项目发行版解压即用，SXLearn-playwright项目需要手动下载浏览器。
...
# 已知问题
可能会被检测到自动化工具操作而无法接收视频，但是不影响网页统计学习时间，可正常获得学时。
